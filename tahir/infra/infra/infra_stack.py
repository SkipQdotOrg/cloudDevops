...
from aws_cdk import core, aws_events, aws_events_targets, aws_iam
...
class InfraStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        hw_lambda_fn = self.create_lambda('tahir-skipLambda', './lambda', 'metric_publisher.publish_metrics', lambda_role)
